...
Install docker environment from https://www.docker.com/get-started

Dockerize spring-boot service that you created in scope of HT_5
          (create Dockerfile and build image using docker build command)

 Create docker-compose.yaml which consists of network configuration and two services (spring-boot application and database)
